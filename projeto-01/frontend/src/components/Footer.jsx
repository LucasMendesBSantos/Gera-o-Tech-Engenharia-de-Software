    ...
    <footer className="footer">
        ...
        <div className="footer__col">
          ...
          <ul>
            {NAV_LINKS.map(({ href, label }) => (
              <li key={href}><a href={isHome ? href : `/${href}`}>{label}</a></li>
            ))}
          </ul>
        </div>
      </div>
      ...
      <div className="footer__bottom">
        ...
        <div className="footer__social">
          <a href="https://www.instagram.com/" className="footer__social-link" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
